...
export const spotify = {
  me: (t) => req('/me', t),
  featured: (t) => req('/browse/featured-playlists?limit=20', t),
  newReleases: (t) => req('/browse/new-releases?limit=20', t),
  categories: (t) => req('/browse/categories?limit=20', t),
  ...
  playlist: (t, id) => req(`/playlists/${id}`, t),
  playlistTracks: (t, id) => req(`/playlists/${id}/tracks?limit=100`, t),
