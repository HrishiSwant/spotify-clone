...
export const spotify = {
  ...
  async playlist(token, id) {
    ...
    // If Spotify already returned tracks, use them.
    if (
      playlist.tracks &&
    ...
    // Otherwise try fetching them separately.
    try {
      ...
      // Don't fail the whole playlist page if track fetch fails.
      console.warn("Playlist tracks unavailable:", err);
